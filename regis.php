...
/*
$usernamequery="select * from registration where name=$name";
$namequery=mysqli_query($conn,$usernamequery);
...
$insertquery="INSERT into registration(name,email,contact,password,cpassword)
...
if($result){
  ...
  ?>
  <script>
  alert("sryy!! Registration Unsuccefull");
